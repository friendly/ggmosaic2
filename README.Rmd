...
`Sex`, `Eye`, and `Hair`, via the area of each tile. To accommodate the alternate splitting
in horizontal and vertical directions, `geom_mosaic()` uses a `product()` to specify the
