...
```{r example}
#| fig.alt: >
#|   Mosaicplot of the HairEyeColor dataset from base R. Certain combinations of
#|   hair colour, eye colour, and biological sex are more/less common than 
#|   would be expected if these variables were independent of one another.
library(ggmosaic2)
