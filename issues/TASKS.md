...
- [X] Fixed issue [#82](https://github.com/haleyjeppson/ggmosaic/issues/82) from `haleyjeppson/ggmosaic`, where one couldn't use ggmosaic code without importing it into the current namespace.
